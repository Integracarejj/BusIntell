        ...
        "BudgetGrid.useMemo[columns]": ()=>{
            return [
                ...
                },
                {
                    id: "__year",
                    accessorFn: {
                        "BudgetGrid.useMemo[columns]": (row)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$grid$2f$filters$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseYearFromPeriod"])(row.period)
                    }["BudgetGrid.useMemo[columns]"],
                    header: "Year (hidden)",
                    enableHiding: true,
                    meta: {
                    ...
                    filterFn: {
                        "BudgetGrid.useMemo[columns]": (row, id, val)=>!val || String(row.getValue(id) ?? "") === String(val)
                    }["BudgetGrid.useMemo[columns]"]
                }
            ];
        }
...
//# sourceMappingURL=components_ef72b641._.js.map