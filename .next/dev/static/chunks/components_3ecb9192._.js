...
function ToolbarFilters({ table, filters, setFilters, onClear, onExport, yearOptions = [
    ...
    _s();
    // ----- helpers -----
    const getFilter = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "ToolbarFilters.useCallback[getFilter]": (id)=>filters.find({
                "ToolbarFilters.useCallback[getFilter]": (f)=>f.id === id
            }["ToolbarFilters.useCallback[getFilter]"])?.value
    }["ToolbarFilters.useCallback[getFilter]"], [
        filters
    ]);
    const setFilter = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "ToolbarFilters.useCallback[setFilter]": (id, value)=>{
            setFilters({
                "ToolbarFilters.useCallback[setFilter]": (old)=>{
                    const others = old.filter({
                        "ToolbarFilters.useCallback[setFilter].others": (f)=>f.id !== id
                    }["ToolbarFilters.useCallback[setFilter].others"]);
            ...
            }["ToolbarFilters.useCallback[setFilter]"]);
    ...
    // ----- option derivation -----
    const communityOptions = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ToolbarFilters.useMemo[communityOptions]": ()=>{
            const set = new Set();
            table.getPreFilteredRowModel().rows.forEach({
                "ToolbarFilters.useMemo[communityOptions]": (r)=>{
                    const v = String(r.getValue(communityColumnId) ?? "");
                    if (v) set.add(v);
                }
            }["ToolbarFilters.useMemo[communityOptions]"]);
            return Array.from(set).sort({
                "ToolbarFilters.useMemo[communityOptions]": (a, b)=>a.localeCompare(b)
            }["ToolbarFilters.useMemo[communityOptions]"]).map({
                "ToolbarFilters.useMemo[communityOptions]": (v)=>({
                        value: v,
                        label: v
                    })
            }["ToolbarFilters.useMemo[communityOptions]"]);
    ...
    const yearOpts = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ToolbarFilters.useMemo[yearOpts]": ()=>yearOptions.map({
                "ToolbarFilters.useMemo[yearOpts]": (y)=>({
                        value: y,
                        label: y
                    })
            }["ToolbarFilters.useMemo[yearOpts]"])
    }["ToolbarFilters.useMemo[yearOpts]"], [
        yearOptions
    ]);
    const typeOpts = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ToolbarFilters.useMemo[typeOpts]": ()=>typeOptions.map({
                "ToolbarFilters.useMemo[typeOpts]": (t)=>({
                        value: t,
                        label: t
                    })
            }["ToolbarFilters.useMemo[typeOpts]"])
    }["ToolbarFilters.useMemo[typeOpts]"], [
        typeOptions
    ]);
    ...
    const categoryOptions = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ToolbarFilters.useMemo[categoryOptions]": ()=>{
            const rows = table.getPreFilteredRowModel().rows.filter({
                "ToolbarFilters.useMemo[categoryOptions].rows": (r)=>{
            ...
            }["ToolbarFilters.useMemo[categoryOptions].rows"]);
            const set = new Set();
            rows.forEach({
                "ToolbarFilters.useMemo[categoryOptions]": (rr)=>{
                    const v = String(rr.getValue(categoryColumnId) ?? "");
                    if (v) set.add(v);
                }
            }["ToolbarFilters.useMemo[categoryOptions]"]);
            return Array.from(set).sort({
                "ToolbarFilters.useMemo[categoryOptions]": (a, b)=>a.localeCompare(b)
            }["ToolbarFilters.useMemo[categoryOptions]"]).map({
                "ToolbarFilters.useMemo[categoryOptions]": (v)=>({
                        value: v,
                        label: v
                    })
            }["ToolbarFilters.useMemo[categoryOptions]"]);
...
_s(ToolbarFilters, "eww1zyjMA0F3gmuV7l7ThesiD2s=");
_c = ToolbarFilters;
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Caret, {}, void 0, false, {
                        fileName: "[project]/components/grid/ToolbarFilters.tsx",
                        lineNumber: 239,
                        columnNumber: 17
                    }, this)
...
__turbopack_context__.k.register(_c3, "Caret");
...
function VirtualRows({ table, height = 720, rowClassName, toggleSelectOnRowClick = true, "aria-label": ariaLabel = "Virtualized grid body" }) {
    ...
    const virtualizer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$virtual$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useVirtualizer"])({
        count: rows.length,
        getScrollElement: {
            "VirtualRows.useVirtualizer[virtualizer]": ()=>parentRef.current
        }["VirtualRows.useVirtualizer[virtualizer]"],
        estimateSize: {
            "VirtualRows.useVirtualizer[virtualizer]": ()=>40
        }["VirtualRows.useVirtualizer[virtualizer]"],
        overscan: 8
    });
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: virtualItems.map((vi)=>{
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: visibleCells.map((cell)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "pr-2",
...
_s(VirtualRows, "K76ONSIdu1OYrroVo+jA7ySqV+Q=", false, function() {
    return [
...
"[project]/components/grid/ColumnMenu.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useOutsideClick(ref, onClickAway) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "useOutsideClick.useEffect": ()=>{
            ...
            return ({
                "useOutsideClick.useEffect": ()=>document.removeEventListener("mousedown", handler)
            })["useOutsideClick.useEffect"];
        }
    }["useOutsideClick.useEffect"], [
        onClickAway,
...
function ColumnMenu({ table, column }) {
    ...
    const popRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"](null);
    // Close on outside click
    useOutsideClick(popRef, {
        "ColumnMenu.useOutsideClick": ()=>setOpen(false)
    }["ColumnMenu.useOutsideClick"]);
    // Close on escape
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "ColumnMenu.useEffect": ()=>{
            function onKey(e) {
                if (e.key === "Escape") setOpen(false);
            }
            document.addEventListener("keydown", onKey);
            return ({
                "ColumnMenu.useEffect": ()=>document.removeEventListener("keydown", onKey)
            })["ColumnMenu.useEffect"];
        }
    }["ColumnMenu.useEffect"], []);
    ...
    const autoSize = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "ColumnMenu.useCallback[autoSize]": ()=>{
            ...
            const measure = {
                "ColumnMenu.useCallback[autoSize].measure": (txt)=>Math.ceil(ctx.measureText((txt ?? "").toString()).width)
            }["ColumnMenu.useCallback[autoSize].measure"];
            ...
            const cellW = sampleRows.reduce({
                "ColumnMenu.useCallback[autoSize].cellW": (max, r)=>{
                    const v = r.getValue(column.id);
                    return Math.max(max, measure(v));
                }
            }["ColumnMenu.useCallback[autoSize].cellW"], 0);
            ...
            table.setColumnSizing({
                "ColumnMenu.useCallback[autoSize]": (prev)=>({
                        ...prev,
                        [column.id]: clamped
                    })
            }["ColumnMenu.useCallback[autoSize]"]);
    ...
    const resetWidth = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "ColumnMenu.useCallback[resetWidth]": ()=>{
            // Reset to no explicit size; TanStack will use default size or CSS.
            table.setColumnSizing({
                "ColumnMenu.useCallback[resetWidth]": (prev)=>{
        ...
        children: [
            ...
            open && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    pinState && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Item, {
...
_s1(ColumnMenu, "ru8RT8qn5HjnOxFyIFjYg8VpUoc=", false, function() {
    return [
        useOutsideClick
    ];
});
...
_c3 = Item;
var _c, _c1, _c2, _c3;
__turbopack_context__.k.register(_c, "ColumnMenu");
__turbopack_context__.k.register(_c1, "Section");
__turbopack_context__.k.register(_c2, "Separator");
__turbopack_context__.k.register(_c3, "Item");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/grid/export.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function exportRowsToXlsx(rows, columns, fileName = "budget-grid.xlsx") {
    try {
        const XLSX = await __turbopack_context__.A("[project]/node_modules/xlsx/xlsx.mjs [app-client] (ecmascript, async loader)"); // requires 'xlsx' to be installed
        const colIds = columns.map((c)=>"accessorKey" in c && c.accessorKey ? String(c.accessorKey) : c.id ? String(c.id) : null).filter(Boolean);
        const data = [
            colIds,
...
"[project]/components/grid/filters.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$grid$2f$filters$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/grid/filters.tsx [app-client] (ecmascript)");
;
;
;
    ...
    return [
        {
            ...
            filterFn: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$grid$2f$filters$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["multiIncludesSome"],
            enablePinning: true
        },
        {
            id: "type",
            ...
            header: "Type",
            size: 130,
            filterFn: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$grid$2f$filters$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["equalsString"]
        },
        {
            id: "category",
        ...
        // Amount column: wrap AmountCell without JSX (this file is .ts)
        {
            ...
            header: "Amount",
            size: 140,
            cell: (ctx)=>/*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$grid$2f$AmountCell$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        ...
        {
            id: "__year",
            accessorFn: (row)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$grid$2f$filters$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseYearFromPeriod"])(row.period),
            header: "Year (hidden)",
            enableHiding: true,
            meta: {
                hiddenHelper: true
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$grid$2f$AmountCell$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/grid/AmountCell.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$grid$2f$ColumnMenu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/grid/ColumnMenu.tsx [app-client] (ecmascript)");
// ───────────────────────────────────────────────────────────────────────────────
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$grid$2f$export$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/grid/export.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
...
try {
    ...
    const totalsMod = __turbopack_context__.r("[project]/components/grid/totals.ts [app-client] (ecmascript)");
    buildTotals = totalsMod.buildTotals;
} catch  {
    buildTotals = ()=>({});
}
;
const exportRowsToCsv = __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$grid$2f$export$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__.exportRowsToCsv ?? ((..._args)=>{});
function BudgetGrid({ rows, onRowsChange, className }) {
    ...
    const [columnPinning, setColumnPinning] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]({
        left: [],
        right: []
    });
    const [columnSizing, setColumnSizing] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]({});
    ...
    const columns = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "BudgetGrid.useMemo[columns]": ()=>{
            // eslint-disable-next-line @typescript-eslint/no-var-requires
            const mod = __turbopack_context__.r("[project]/components/grid/columns.ts [app-client] (ecmascript)");
            const factory = mod.budgetColumns ?? mod.getColumns ?? mod.columns ?? mod.default;
            if (typeof factory === "function") {
                return factory({
                    AmountCell: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$grid$2f$AmountCell$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
                });
            }
    ...
    const table = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$table$2f$build$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useReactTable"])({
        ...
        meta: {
            commitAmount: {
                "BudgetGrid.useReactTable[table]": (rowIndex, value)=>{
    ...
    const totals = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "BudgetGrid.useMemo[totals]": ()=>buildTotals(table.getFilteredRowModel().rows)
    }["BudgetGrid.useMemo[totals]"], [
        table
    ]);
    // ── Export CSV; try (table) signature, then (rows, columns)
    const exportCsv = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "BudgetGrid.useCallback[exportCsv]": ()=>{
            try {
                return exportRowsToCsv(table);
            } catch  {
                const data = table.getFilteredRowModel().rows.map({
                    "BudgetGrid.useCallback[exportCsv].data": (r)=>r.original
                }["BudgetGrid.useCallback[exportCsv].data"]);
                const cols = table.getAllLeafColumns().map({
                    "BudgetGrid.useCallback[exportCsv].cols": (c)=>{
                        const accessorFn = c.columnDef.accessorFn;
                        return {
                            id: c.id,
                            header: c.columnDef.header,
                            accessorFn: accessorFn ?? ({
                                "BudgetGrid.useCallback[exportCsv].cols": (row)=>row[c.id]
                            })["BudgetGrid.useCallback[exportCsv].cols"]
                        };
                    }
                }["BudgetGrid.useCallback[exportCsv].cols"]);
                                ...
                                children: table.getHeaderGroups().map((hg)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        children: hg.headers.map((header)=>{
                                            ...
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                                ...
                                                children: [
                                                    header.isPlaceholder ? null : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                ...
                                                                children: [
                                                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$table$2f$build$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["flexRender"])(col.columnDef.header, header.getContext()),
                                                                    col.getIsSorted() && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$grid$2f$ColumnMenu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                                table: table,
                                                                column: col
                                                            }, void 0, false, {
                                                                fileName: "[project]/components/BudgetGrid.tanstack.tsx",
...
_s(BudgetGrid, "IgnSZEAAHLykAMwC1OToOj9EJ1c=", false, function() {
    return [
...
//# sourceMappingURL=components_3ecb9192._.js.map